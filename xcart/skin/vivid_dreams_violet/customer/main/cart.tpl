{*
c4876f0dc3c1be77d432d7277a473c36b8ae058c, v15 (xcart_4_6_1^2), 2013-09-07 11:40:24, cart.tpl, random
              ...
              <tr>
                <td class="image">
                    {if $active_modules.On_Sale}
                      {include file="modules/On_Sale/on_sale_icon.tpl" product=$product current_skin="vivid_dreams" module="cart"}
                    {else}
