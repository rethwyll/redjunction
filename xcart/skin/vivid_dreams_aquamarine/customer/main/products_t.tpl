{*
d34f04f66485fd273a3ca658bb941a5ccd2d3c76, v17 (xcart_4_6_1^2), 2013-09-09 15:27:35, products_t.tpl, aim
...
//]]>
      ...
      {if $active_modules.Advanced_Customer_Reviews}
        {include file="modules/Advanced_Customer_Reviews/acr_products_t.tpl" break_line="Y"}
      {/if}
          ...
          {if $product}
            ...
            <td{interline name=products additional_class="product-cell product-cell-price"}>
              ...
              {/if}
                ...
                {elseif $config.Appearance.buynow_button_enabled eq "Y" and $product.product_type ne "C" and not $printable}
                  {if $login ne ""}
