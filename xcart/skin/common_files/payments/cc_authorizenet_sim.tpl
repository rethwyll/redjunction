...
<td><input type="text" name="param04" size="36" maxlength="14" value="{$module_data.param04|escape}" />{include file="main/tooltip_js.tpl" text=$lng.txt_cc_authorizenet_prefix_help id="order_prefix_help" type='img' width=400}</td>
</tr>
