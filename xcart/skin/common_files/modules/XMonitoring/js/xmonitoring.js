 ...
 * @version    fb6c3380ee54b2582ac3726654777711577fe132, v3 (xcart_4_6_0), 2013-03-19 11:46:40, xmonitoring.js, random
...
var xmonitoring = {
    ...
    reDrawCharts: function(tabsUI) {
        if (typeof $ != 'undefined') {
            if (tabsUI.tab
                && tabsUI.tab.hash == '#xmonitoring-tabs-availibility') {
                /* remove hidden style */
                $('#xmonitoring-tabs-availibility').removeClass('ui-tabs-hide');
                /* redraw charts */
