{*
3039bf3eb094e2b4575469bee1921cf07373145a, v3 (xcart_4_6_1), 2013-07-26 16:43:32, advanced_stats.tpl, random
...
<tr>
  ...
  <td valign="top" width="90%" class="Text">{if $current_membership_flag eq "FS"}{$product_viewes[index].product}{else}<a href="{$catalogs.customer}/product.php?productid={$product_viewes[index].productid}&amp;is_admin_preview=Y" target="_blank">{$product_viewes[index].product}</a>{/if}</td>
...
<tr>
  ...
  <td valign="top" width="90%" class="Text"><a href="{$catalogs.customer}/product.php?productid={$product_sales[index].productid}&amp;is_admin_preview=Y" target="_blank">{$product_sales[index].product}</a></td>
...
<tr>
  ...
  <td valign="top" width="90%" class="Text"><a href="{$catalogs.customer}/product.php?productid={$product_deleted[index].productid}&amp;is_admin_preview=Y" target="_blank">{$product_deleted[index].product}</a></td>
