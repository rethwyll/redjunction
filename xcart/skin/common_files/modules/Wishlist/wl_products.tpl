{*
a9aed606f83f987f4472c1fcbc58882929ffce84, v10 (xcart_4_6_0), 2013-05-23 10:19:08, wl_products.tpl, random
...
{if $wl_products ne "" or ($active_modules.Gift_Certificates ne "" and $wl_giftcerts ne "")}
  ...
  <div class="products cart wishlist">
            ...
            <tr>
              <td class="image">
                  {if $active_modules.On_Sale}
                    {include file="modules/On_Sale/on_sale_icon.tpl" product=$product module="wl_products"}
                  {else}
