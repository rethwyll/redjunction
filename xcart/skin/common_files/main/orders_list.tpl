{*
da956935ab977ea64f087b6c5911826fc80eb1f2, v14 (xcart_4_5_4), 2012-10-21 12:58:55, orders_list.tpl, aim
...
<tr{cycle values=", class='TableSubHead'"}>
  ...
  <td nowrap="nowrap"{if $active_modules.XOrder_Statuses && $config.XOrder_Statuses.use_colors eq 'Y'} bgcolor="#{$orders[oid].status|order_status_color}"{/if}>
{if $is_admin_user}
