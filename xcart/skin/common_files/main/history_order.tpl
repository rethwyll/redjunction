{*
458e83dda4c290604cde421f030368ebfd4b13aa, v18 (xcart_4_6_1), 2013-08-27 09:51:49, history_order.tpl, aim
...
{else}
{if $ship_code eq "1800C"}
<a href="https://www.1-800courier.com/tracking.asp?code={$order.tracking}" target='_blank'>{$lng.lbl_1800c_quick_track}</a>
{/if}
{/if}
