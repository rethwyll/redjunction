{*
c4876f0dc3c1be77d432d7277a473c36b8ae058c, v18 (xcart_4_6_1), 2013-09-07 11:40:24, product_details.tpl, random
  ...
  <table cellspacing="0" class="product-properties" summary="{$lng.lbl_description|escape}">
	...
	<tr>
		...
		{if $product.appearance.has_market_price and $product.appearance.market_price_discount gt 0}
			{$lng.lbl_market_price}: {currency value=$product.list_price},
			<span class="you-save">{$lng.lbl_save} {math equation="x-y" x=$product.taxed_price y=$product.list_price assign="you_save"}{currency value=$you_save}</span>
		{/if}
