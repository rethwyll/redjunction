{*
b10909643045fa57d33730a73b27a81ebcc5df7b, v12 (xcart_4_6_1), 2013-08-30 12:55:46, product.tpl, random
      ...
      {else}
          ...
          <div class="image-box" style="{if $max_image_width gt 0}width: {math equation="x+14" x=$max_image_width}px;{/if}">
            {if $active_modules.On_Sale}
              {include file="modules/On_Sale/on_sale_icon.tpl" product=$product module="product" module="product"}
            {else}
