{*
8ec8b858917c921a726e2197071ce74d020e5ead, v1 (xcart_4_6_0), 2013-04-02 16:43:59, address_fields.tpl, random
...
*}
  ...
  {if $default_fields.title.avail eq 'Y'}
    <div class="address-field">
      ...
      <div{if $default_fields.title.required eq 'Y'} class="data-required">*{else} class="data-required">&nbsp;{/if}</div>
  ...
  {if $default_fields.firstname.avail eq 'Y'}
    <div class="address-field">
      ...
      <div{if $default_fields.firstname.required eq 'Y'} class="data-required">*{else} class="data-required">&nbsp;{/if}</div>
  ...
  {if $default_fields.lastname.avail eq 'Y'}
    <div class="address-field">
      ...
      <div{if $default_fields.lastname.required eq 'Y'} class="data-required">*{else} class="data-required">&nbsp;{/if}</div>
  ...
  {if $default_fields.address.avail eq 'Y'}
    <div class="address-field">
      ...
      <div{if $default_fields.address.required eq 'Y'} class="data-required">*{else} class="data-required">&nbsp;{/if}</div>
  ...
  {if $default_fields.address_2.avail eq 'Y'}
    <div class="address-field">
      ...
      <div{if $default_fields.address_2.required eq 'Y'} class="data-required">*{else} class="data-required">&nbsp;{/if}</div>
  ...
  {if $default_fields.city.avail eq 'Y'}
    <div class="address-field">
      ...
      <div{if $default_fields.city.required eq 'Y'} class="data-required">*{else} class="data-required">&nbsp;{/if}</div>
  ...
  {if $default_fields.county.avail eq 'Y' and $config.General.use_counties eq "Y"}
    <div class="address-field">
      ...
      <div{if $default_fields.county.required eq 'Y'} class="data-required">*{else} class="data-required">&nbsp;{/if}</div>
  ...
  {if $default_fields.state.avail eq 'Y'}
    <div class="address-field">
      ...
      <div{if $default_fields.state.required eq 'Y'} class="data-required">*{else} class="data-required">&nbsp;{/if}</div>
  ...
  {if $default_fields.country.avail eq 'Y'}
    <div class="address-field">
      ...
      <div{if $default_fields.country.required eq 'Y'} class="data-required">*{else} class="data-required">&nbsp;{/if}</div>
  ...
  {if $default_fields.state.avail eq 'Y' and $default_fields.country.avail eq 'Y'}
    <div style="display: none;">
      <div{if $default_fields.state.required eq 'Y'} class="data-required"{/if}>
  ...
  {if $default_fields.zipcode.avail eq 'Y'}
    <div class="address-field">
      ...
      <div{if $default_fields.zipcode.required eq 'Y'} class="data-required">*{else} class="data-required">&nbsp;{/if}</div>
  ...
  {if $default_fields.phone.avail eq 'Y'}
    <div class="address-field">
      ...
      <div{if $default_fields.phone.required eq 'Y'} class="data-required">*{else} class="data-required">&nbsp;{/if}</div>
  ...
  {if $default_fields.fax.avail eq 'Y'}
    <div class="address-field">
      ...
      <div{if $default_fields.fax.required eq 'Y'} class="data-required">*{else} class="data-required">&nbsp;{/if}</div>
  ...
  {if $additional_fields ne ''}
    ...
    <div class="address-field">
      ...
      <div{if $v.required eq 'Y'} class="data-required">*{else}>&nbsp;{/if}</div>
        {if $v.type eq 'T'}
