 ...
 * @version    0397c0c54b7fd697ad3aae505050655ccfeca10a, v2 (xcart_4_6_0), 2013-05-27 16:38:40, cc_klarna.php, random
...
if ($REQUEST_METHOD == 'POST' && !empty($_POST['tid']) && isset($_POST['status']) && !empty($_POST['klarna_response'])) {
    ...
    <form action="<?php print($current_location . '/payment/cc_klarna.php'); ?>" method="post" name="klarna_form" id="klarna_form">
        ...
        <input type="hidden" name="klarna_response" value="<?php print(func_convert_encoding($result[0], $default_charset, 'ISO-8859-1')); ?>" />
