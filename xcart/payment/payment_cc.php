 ...
 * @version    1b44f580ac5b53eeba9e26eb80cba0dcad02da80, v159 (xcart_4_6_1), 2013-09-10 09:53:44, payment_cc.php, random
...
if (!empty($module_params['processor'])) {
    ...
    if ($module_params['background'] == 'I' && !empty($active_modules['Fast_Lane_Checkout'])) {
