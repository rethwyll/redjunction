 ...
 * @version    536d95e589c24076e32b35967cd3b39d91407507, v21 (xcart_4_5_5), 2013-02-04 14:14:03, cc_csrc_form.php, aim
...
if ($REQUEST_METHOD == 'POST' && !empty($_POST['signedFields'])) {
    ...
    $post = array(
        ...
        'billTo_firstName'                  => $cs_user_info['b_firstname'],
        'billTo_lastName'                   => $cs_user_info['b_lastname'],
