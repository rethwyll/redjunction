 ...
 * @version    23196386309deb4e112be7cabb6d007d641a73b1, v5 (xcart_4_6_1), 2013-08-21 11:13:31, cc_gge4_hc.php, aim
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['x_response_code']) {
    ...
    $transaction_type_name = func_check_cc_trans ('First Data Global Gateway e4 - Hosted Payment Pages', $transaction_type, array("P" => "auth_capture", "C" => "auth_only", "X" => "prior_auth_capture", "V" => "void"));
    ...
    if (!$follow_on) {
        ...
        func_create_payment_form($url, $fields, 'First Data Global Gateway e4 - Hosted Payment Pages');
