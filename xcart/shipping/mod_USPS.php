 ...
 * @version    4e52975b17d5393244dab387b0c4bc845935cc54, v129 (xcart_4_6_1), 2013-09-11 15:58:07, mod_USPS.php, aim
...
EOT;
        ...
        // https://www.usps.com/business/web-tools-apis/rate-calculators-v1-7a.htm#OLE_LINK8
        ...
        $common_dim_girth_xml = func_USPS_get_xml_girth($package_size, '', $dim_girth_xml);
        $services = array(
            'STANDARD POST' => array('container' => '', 'machinable' => "<Machinable>$machinable</Machinable>", 'size' => $package_size, '_girth' => $dim_girth_xml),
        );
