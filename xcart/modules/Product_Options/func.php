 ...
 * @version    360975f11638e59bcee8d1e06a7d3158242b89cc, v162 (xcart_4_6_0), 2013-05-17 11:37:20, func.php, aim
...
class XCVariantsSQL {
    ...
    public static function getJoinQueryAllRows($alias = array()) { // {{{
        ...
        $join_type = XCVariantsSQL::isOptimizationEnabled() ? 'INNER' : 'LEFT';
    ...
    public static function isOptimizationEnabled() { // {{{
        global $config;
...
function func_rebuild_variants($productid, $force_rebuild = false, $tick = 1, $save_variants_data = true)
{
    ...
    do {
        ...
        if (empty($variantid))
            continue;
        elseif(XCVariantsSQL::isOptimizationEnabled()) {
            $need_repair = FALSE;
        }
