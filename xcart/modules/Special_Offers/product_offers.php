 ...
 * @version    efb3edd7fcc389eb4b1ae6e54daf6b2aef9215c6, v32 (xcart_4_6_1), 2013-08-09 19:36:23, product_offers.php, random
        ...
        foreach ($sorted_offers as $offer) {
            ...
            if ($s_condition) {
                ...
                foreach ($s_condition['params'] as $k => $param) {
                    ...
                    $add_product = ($param['param_id'] == $productid) ? $product_info : func_select_product($param['param_id'], $customer_info['membershipid'], FALSE);
