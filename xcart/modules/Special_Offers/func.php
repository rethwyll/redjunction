 ...
 * @version    4691fa0119ded04fa746eac062355327f7eeb48b, v160 (xcart_4_6_1), 2013-09-04 18:22:02, func.php, aim
...
function func_bonus_free_sort($a, $b) { //{{{
    ...
    if (
        @$a['is_free_product'] == 'Y' && @$b['is_free_product'] != 'Y'
...
function func_special_offers_init() { //{{{
    ...
    $plugin_dir = $xcart_dir . XC_DS . 'modules' . XC_DS . 'Special_Offers';

    array_unshift($smarty->plugins_dir, $plugin_dir);

    array_unshift($mail_smarty->plugins_dir, $plugin_dir);
...
class XCCalculateSO {
     ...
     */
    public static function applyDiscountsS2(&$applied_offers, &$products, &$offers_order_bonuses) { //{{{
