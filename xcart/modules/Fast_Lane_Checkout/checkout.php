 ...
 * @version    ffe0f5e02cea81fd13b354c028b26b0180dabb13, v47 (xcart_4_6_1), 2013-09-12 09:12:56, checkout.php, random
...
if (!empty($paymentid)) {
    ...
    if ($active_modules['Bill_Me_Later'] && $paymentid == $paypal_bmlid) {
    ...
    if (
        ...
        if (!func_is_confirmed_paypal_express()) {
            ...
            func_header_location($current_location . '/payment/' . $ec_script . '?payment_id=' . $paymentid . '&mode=express&useraction=commit');
