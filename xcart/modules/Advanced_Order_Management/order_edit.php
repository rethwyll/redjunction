 ...
 * @version    d4a76d1a4181e4d00bd33a82ac5ea6f99a377dc4, v157 (xcart_4_6_1), 2013-08-21 09:17:54, order_edit.php, aim
...
if (!x_session_is_registered('cart_tmp') || !empty($initial_point)) {
    ...
    $cart_tmp['userinfo']['id'] = isset($cart_tmp['userinfo']['id']) ? $cart_tmp['userinfo']['id'] : 0;
...
if ($REQUEST_METHOD == 'POST') {
    ...
    if ($action == 'update_products') {
        ...
        if (!empty($newproductid) && is_numeric($newproductid)) {
            ...
            func_set_anonymous_userinfo($cart_tmp['userinfo'], 'skip_x_session_save');
    ...
    elseif ($action == 'update_customer') {
        ...
        foreach ($address_book as $type => $address) {
            ...
            $cart_tmp['userinfo'] = func_array_merge(
                $cart_tmp['userinfo'],
...
$shipping_cost_alt_old = isset($cart_tmp['use_shipping_cost_alt']) ? $cart_tmp['use_shipping_cost_alt'] : '';
