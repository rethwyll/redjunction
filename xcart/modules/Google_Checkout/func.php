 ...
 * @version    9df6dd07d3de28aa06390569ce8e31203a80c3bd, v49 (xcart_4_6_0), 2013-05-04 11:57:40, func.php, aim
...
function func_is_gcheckout_button_enabled ()
{
    ...
    if (!empty($cart['products']) && is_array($cart['products'])) {
        ...
        $_restriction_found = func_query_hash("SELECT productid, COUNT(*) as counter FROM $sql_tbl[gcheckout_restrictions] WHERE productid IN ('" . implode("','", $_pid) . "') GROUP BY productid ORDER BY NULL", "productid", false);
