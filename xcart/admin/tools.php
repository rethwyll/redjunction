 ...
 * @version    d8861048c38cd96c7bce31a65e6192e5267b2894, v193 (xcart_4_6_1), 2013-08-28 11:15:33, tools.php, aim
...
// {{{
    ...
    if ($_POST['track_stat'] == 'Y') {
        ...
        if (empty($rsd_limit)) {
            ...
            $query = "SELECT $sql_tbl[stats_pages].pageid FROM $sql_tbl[stats_pages] LEFT JOIN $sql_tbl[stats_pages_views] ON $sql_tbl[stats_pages].pageid = $sql_tbl[stats_pages_views].pageid WHERE $sql_tbl[stats_pages_views].pageid IS NULL GROUP BY $sql_tbl[stats_pages].pageid ORDER BY NULL LIMIT 100";
