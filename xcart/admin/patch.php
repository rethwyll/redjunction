 ...
 * @version    67b60625be21688eb1c1aa163c24698107bcb55d, v111 (xcart_4_6_1), 2013-09-09 15:17:25, patch.php, aim
...
if ($REQUEST_METHOD == 'POST') {
    ...
    if (function_exists('func_check_perms_redirect')) {
        ...
        version_compare($config['version'], '4.5.5') < 0
        && file_exists($upgrade_repository . XC_DS . $patch_filename . XC_DS . 'allow2upgrade_key')
    ) {
        // This is upgrade from 4.5.4 and below versions to 4.5.5+
        function func_check_perms_redirect($arg) {}
        class XCActions{const UPGRADE='';const PATCH_FILES='';}
    }
