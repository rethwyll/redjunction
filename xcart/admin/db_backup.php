 ...
 * @version    2d5a08005aaf657ee372b4f48bc08fc9e2dc8107, v108 (xcart_4_6_1), 2013-06-21 09:26:42, db_backup.php, aim
...
if ($REQUEST_METHOD == 'POST' && $mode == 'restore' && (($userfile != 'none' && $userfile != '') || ($_POST['local_file'] && $file_exists))) {
    ...
    func_remove_xcart_caches(); // language variables may change
