 ...
 * @version    65b7514a2d1fb5513d536783836bd5c73ec7f58e, v101 (xcart_4_6_1), 2013-08-16 15:40:25, shipping_options.php, aim
...
if ($carrier == 'USPS') {
    ...
    $shipping_options[strtolower($carrier)]['dim_girth'] = $_dim[3];

    if (is_numeric($shipping_options[strtolower($carrier)]["param07"]))
        $shipping_options[strtolower($carrier)]['fixed_value'] = 'Y';
}
