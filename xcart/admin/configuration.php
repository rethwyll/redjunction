 ...
 * @version    c4876f0dc3c1be77d432d7277a473c36b8ae058c, v229 (xcart_4_6_1), 2013-09-07 11:40:24, configuration.php, random
    ...
    if (in_array($v['type'], array("selector","multiselector"))) {
        ...
        foreach ($vars as $vk => $vv) {
            if (!empty($vv) && strpos($vv, "_") !== FALSE && strpos($vv, " ") === FALSE) {
                assert('addslashes($vv) === $vv /* Incorrect variable name */');
