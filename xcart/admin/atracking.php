 ...
 * @version    bed7007031cf286a4daf9cbad5388eec6e7640ab, v58 (xcart_4_6_0), 2013-04-24 12:17:07, atracking.php, aim
        ...
        foreach($statistics as $k => $v) {
            ...
            if (!empty($pages)) {
                foreach($pages as $k1=>$v1) {
                    $query = "SELECT p.page, ROUND(AVG(pv.time_avg),2) as time_avg FROM $sql_tbl[stats_pages_views] as pv, $sql_tbl[stats_pages] as p WHERE p.pageid=pv.pageid AND pv.pageid='$v1' AND $date_condition GROUP BY p.page ORDER BY NULL";
