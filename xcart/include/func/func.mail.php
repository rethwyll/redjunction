 ...
 * @version    4f29f0ebad1ec5edf56cef10724a189ddbbcf90f, v61 (xcart_4_6_1), 2013-09-09 12:26:44, func.mail.php, aim
...
function func_template_exists($template, &$smarty) { // {{{
    $template_dir = is_array($smarty->template_dir) ? $smarty->template_dir : array($smarty->template_dir);
    foreach ($template_dir as $dir) {
        if (file_exists($dir . $template) && is_readable($dir . $template)) {
            return $dir;
        }
    }
