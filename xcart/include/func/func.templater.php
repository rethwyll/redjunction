 ...
 * @version    d76a1d9fe463b64c5dab0d027bd42f6364ff8408, v81 (xcart_4_6_1), 2013-08-27 09:24:47, func.templater.php, aim
...
function func_convert_lang_var($tpl_source, &$smarty)
{
    ...
    foreach ($lng as $code => $vars) {
        ...
        if (!empty($smarty->webmaster_mode) && !empty($data)) {
