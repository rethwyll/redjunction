 ...
 * @version    cc6f174cd4589ddd8d65cf41962341c60e39770e, v114 (xcart_4_6_1), 2013-09-10 15:43:21, func.paypal.php, random
...
function func_paypal_get_line_items_payflow($cart, $pp_total, $pp_currency = NULL) { //{{{
    ...
    if (!empty($pp_paypal_totals)) {
        ...
        if ($discount > 0) {
            ...
            $post['L_NAME' . $item_n] = func_get_langvar_by_name('lbl_discount', NULL, FALSE, TRUE);
            $post['L_COST' . $item_n] = func_paypal_convert_to_BasicAmountType(-$discount, $pp_currency);
            $post['L_QTY' . $item_n] = 1;
