 ...
 * @version    16fb71fefa8aab5678eb4057a41c4de68b748bf6, v163 (xcart_4_6_1), 2013-09-11 13:33:31, func.backoffice.php, aim
 ...
 */
function func_remove_xcart_caches($rebuild_cache = FALSE) { // {{{
    ...
    foreach (array('cache', 'templates_c') as $subdir) {
...
function func_generate_formid($force = false)
{
    ...
    do {
        $stored_md5 = md5(XC_TIME . mt_rand(0, time()) . uniqid(rand(), true));
