 ...
 * @version    d8861048c38cd96c7bce31a65e6192e5267b2894, v87 (xcart_4_6_1), 2013-08-28 11:15:33, product_clone.php, aim
...
if ($product_info['provider']==$logged_userid || $single_mode || $current_area == 'A') {
    ...
    db_query("INSERT INTO $sql_tbl[products] (provider, add_date, productcode, meta_description, meta_keywords, title_tag) VALUES ('$c_userid', '".XC_TIME."', '".addslashes($productcode)."', '', '', '')");
