 ...
 * @version    536d95e589c24076e32b35967cd3b39d91407507, v49 (xcart_4_5_5), 2013-02-04 14:14:03, partner_commission.php, aim
 ...
 */
$partner_plan = func_query_first_cell("SELECT $sql_tbl[partner_commissions].plan_id FROM $sql_tbl[partner_commissions], $sql_tbl[partner_plans], $sql_tbl[customers] WHERE $sql_tbl[partner_commissions].userid='$partner' AND $sql_tbl[partner_commissions].plan_id=$sql_tbl[partner_plans].plan_id AND $sql_tbl[customers].id='$partner' AND $sql_tbl[customers].status='Y' AND $sql_tbl[customers].activity='Y' AND $sql_tbl[partner_plans].status='A'");
